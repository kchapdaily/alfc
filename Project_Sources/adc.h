...
#define ADC_RET_SUCCESS		0

#define ADC_NUM_PIXELS		128
#define ADC_IRQ_NUM			57
...
#ifdef ADC
volatile int adc_rawCameraData[ADC_NUM_PIXELS];
int adc_pixelIndex;
#else
extern volatile int adc_rawCameraData[ADC_NUM_PIXELS];
extern int adc_pixelIndex;
#endif
